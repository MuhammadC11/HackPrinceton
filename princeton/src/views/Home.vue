<template>
  <body>
    ...
    <div class="container">
      <h2 id="survey_input">What level swimmer are you?</h2>
      <select name="level" id="survey_input">
        <option value="blank"></option>
        <option value="beginner">beginner</option>
        <option value="intermediate">intermediate</option>
      </select>
      <h2 id="survey_input">What do you want to get better at?</h2>
      ...
      <h2 id="survey_input">How much time do you have to swim?</h2>
